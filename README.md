...
like so:
<!-- markdownlint-disable MD033 -->
<img width="785" alt="image" src="https://github.com/enchantedpay/telefonistka/assets/1616153/2f7201d6-fdb2-4cbf-8705-d6da7f4f6e80">
<!-- markdownlint-enable MD033 -->

## Roadmap

See the [open issues](https://github.com/enchantedpay/telefonistka/issues) for a list of proposed features (and known issues).
