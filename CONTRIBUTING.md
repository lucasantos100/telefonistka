...
[issues list](https://github.com/wayfair-incubator/telefonistka/issues).
...
- Review and update the existing content of our [Wiki](https://github.com/wayfair-incubator/telefonistka/wiki) with up-to-date
